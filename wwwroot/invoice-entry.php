...
<script type="text/javascript" src="./js/invoice-entry.js"></script>
<link rel="stylesheet" href="./css/invoice.css?v=1" type="text/css" media="all" />
...
<th>Right </th>
<td><div id="Sphere1-D" class="oneField"> <input type="text" id="odsph" name="odsph" value="<?php echo $odSph ?>" size="5" class="rxsphere" /> 
</div></td>
...
<div class="ui-widget">
	<input id="odmulti" name="odmulti" value="<?php echo $odMulti ?>" />
</div>
</div></td>
...
<th>Left </th>
<td><div id="Sphere-D" class="oneField"> <input type="text" id="ossph" name="ossph" value="<?php echo $osSph ?>" size="5" class="rxsphere"/> 
</div></td>
...
<td><div id="MultifocalType-D" class="oneField"> <div class="ui-widget">
	<input id="osmulti" name="osmulti" value="<?php echo $osMulti ?>" />
</div>
</div></td>
...
<input type="submit" class="cancel" id="submit" name="submitAction" value="Save for Later" />
